...
###################################################################################
echo "_______________________________________________________________________________
Begining B2G-Fall13 step
_______________________________________________________________________________" 
if [ -r $release_path/CMSSW_6_2_12_patch1/src ] ; then 
    echo release CMSSW_6_2_12_patch1 already exists
else
    cd $release_path
    scram p CMSSW CMSSW_6_2_12_patch1
fi
cd $release_path/CMSSW_6_2_12_patch1/src
eval `scram runtime -sh`
curl  -s https://raw.githubusercontent.com/cms-sw/genproductions/4cf7516f3f6d9ff8908c90663dbb2135c3e57c9e/python/ThirteenTeV/Hadronizer_Tune4C_13TeV_generic_LHE_pythia8_Tauola_cff.py --retry 2 --create-dirs -o  Configuration/GenProduction/python/ThirteenTeV/Hadronizer_Tune4C_13TeV_generic_LHE_pythia8_Tauola_cff.py 
...
cmsDriver.py Configuration/GenProduction/python/ThirteenTeV/Hadronizer_Tune4C_13TeV_generic_LHE_pythia8_Tauola_cff.py --filein file:$input_file.root --fileout file:$file_out.root --mc --eventcontent RAWSIM --customise SLHCUpgradeSimulations/Configuration/postLS1Customs.customisePostLS1,Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM --conditions POSTLS162_V1::All --step GEN,SIM --magField 38T_PostLS1 --geometry Extended2015 --python_filename B2G-Fall13-00061_1_cfg.py --no_exec -n -1 || exit $? ; 
cmsRun -e -j B2G-Fall13-00061_rt.xml B2G-Fall13-00061_1_cfg.py || exit $? ; 
grep "TotalEvents" B2G-Fall13-00061_rt.xml 
grep "Timing-tstoragefile-write-totalMegabytes" B2G-Fall13-00061_rt.xml 
grep "PeakValueRss" B2G-Fall13-00061_rt.xml 
grep "AvgEventTime" B2G-Fall13-00061_rt.xml 
grep "AvgEventCPU" B2G-Fall13-00061_rt.xml 
grep "TotalJobCPU" B2G-Fall13-00061_rt.xml 
###################################################################################
